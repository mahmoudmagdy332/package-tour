...
<section class="contact py-5">
	<div class="container py-lg-5 py-sm-4" id="container_signup">
        ...
        <div class="Login">
            ...
            @if($id==null)
                <form  method="get" class="row" action= "/check_home" > 
                    ...
                    <div class="col-md-12 booking-button">
                        <a href="/sign" class="btn btn-block sent-butnn" id="Sign-link" >Create a new account</a>
                    </div>
                </form>
   
             @else  
                
                <form  method="get" class="row" action= "/check_package/{{$id}}" > 
                    <div class="col-sm-12 form-group contact-forms">
                    <input type="text" class="form-control" placeholder="E-mail" required="" name="email">
                    </div>
