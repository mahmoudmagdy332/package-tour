...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="/styles.css" rel='stylesheet' type='text/css' /><!-- custom css -->
		...
		<div class="contact-grids">
			<div class="row">
				<div class="col-lg-7 contact-left-form">
                                      ...
                                      <form action='/ticket/{{$id1->package_id}}' method='get' class='row'>
                                        {{ csrf_field() }}
						<div class='col-sm-6 form-group contact-forms'>
                                                    <input type='text' class='form-control' value="{{$id1->package_name}}  " name=' pn'>
						</div>
						<div class='col-sm-6 form-group contact-forms'>
                                              <input type='email' class='form-control' value="{{$id4[0]->email}} " name='email' >
						</div>
						<div class='col-sm-6 form-group contact-forms'>
						...
						<div class="col-md-12 booking-button">
                                                    ...
                                                    <input type="submit" name="submit" class="btn btn-block sent-butnn" value="Book Now" id="lg">
						</div>
					</form>
				</div>
